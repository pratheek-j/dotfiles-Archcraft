...
#PATHS
#lvim
export PATH="$PATH:/home/pratheek/.local/bin"
...
alias config="/usr/bin/git --git-dir=$HOME/dotfiles_Archcraft --work-tree=$HOME"
...
## only for broken keys on lenovo.
## disables function row, <f1> to <f12> 
# <f1> to <f10>, 67-76
...
# numpad 6 to normal 6
xmodmap -e 'keycode 85=6' 
## xmodmap -e 'keycode 16='
# make sure to comment above mods for other systems.
